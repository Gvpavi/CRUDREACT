...
useEffect(() => {
  ...
  async function Load()
  {
     const result = await axios.get(
         "http://localhost:9002/Studentdetails/Student/");
    ...
    try
        {
         await axios.post("http://localhost:9002/Studentdetails/Student/add",
        {
   ...
   async function DeleteStudent(id)
   {
        ...
        await axios.delete("http://localhost:9002/Studentdetails/Student/delete/" + id);
   ...
   try
       {
        ...
        await axios.put("http://localhost:9002/Studentdetails/Student/update/"+ students.find(u => u.id === id).id || id,
       {
         id: id,
         stname: stname,
         course: course,
